...
public class VpnConnection implements Runnable {
    ...
    /**
     * Interfaz Callback para permitir a {@link android.net.VpnService} conocer acerca de nuevas conexiones
     * y actualizar la notificación en primer plano con el estado de la conexion.
     */
    ...
    /**
     * tiempo de espera entre la conexion perdida y el volver a intentarlo.
     */
    ...
    /** Tiempo de espera sin recibir un mensaje cuando se asume que el servicio ya se detuvo. */
    ...
    public void setmOnEstablishListener(OnEstablishListener mOnEstablishListener) {
        this.mOnEstablishListener = mOnEstablishListener;
        mOnEstablishListener = mOnEstablishListener;
    }
